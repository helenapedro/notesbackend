...
public class UserService {
	...
	public Page<User> getAllUsers(Pageable pageable, Sort sort) {
	...
	public User updateUser(RegisterUserDto updateUserDto, Long uid, Long requestingUserId) {
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
	    ...
	    return new UserDetailsImpl(user.getUid(), user.getEmail(), user.getPassword(), authorities);
	}

	
	// This method will check if the requesting user has the ROLE_ADMIN authority
